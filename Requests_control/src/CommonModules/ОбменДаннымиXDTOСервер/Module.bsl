...
Процедура ИнициализироватьТаблицыПравилОбмена(КомпонентыОбмена) Экспорт
	...
	КомпонентыОбмена.Вставить("ПравилаКонвертацииОбъектов", ТаблицаПравилКонвертации(XMLСхема, МенеджерОбмена, НаправлениеОбмена));
...
Функция СтруктураОбъектаXDTOВДанныеИБ(КомпонентыОбмена, ДанныеXDTO, ПравилоКонвертации, Действие = "КонвертироватьИЗаписать") Экспорт
	...
	Если Действие = "КонвертироватьИЗаписать" Тогда
		...
		Если КомпонентыОбмена.ЭтоОбменЧерезПланОбмена И НЕ ПравилоКонвертации.ЭтоРегистрСведений Тогда
			...
			#Область СистемныйОбработчикПриПолученииДанныхОтПодчиненного
				...
				ОтправкаНазад = Ложь;
				СтандартныеПодсистемыСервер.ПриПолученииДанныхОтПодчиненного(ДанныеДляЗаписиВИБ, ПолучениеЭлемента, ОтправкаНазад, КомпонентыОбмена.УзелКорреспондента);
			#КонецОбласти
...
Функция ТаблицаПравилКонвертации(XMLСхема, МенеджерОбмена , НаправлениеОбмена)
