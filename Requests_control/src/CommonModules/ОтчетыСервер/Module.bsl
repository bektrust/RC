...
Функция ЗарегистрироватьПользовательскуюНастройку(Информация, СвойстваНастройки, СтрокаДерева, НастройкаВарианта)
	...
	СвойстваНастройки.ПредставлениеПоУмолчанию = СвойстваНастройки.Представление;
...
Процедура ЗаполнитьПредставлениеНастройки(СвойстваНастройки, НастройкаВариантаКД, ПользовательскаяНастройкаКД, ДоступнаяНастройкаКД)
	...
	Если Не ЗначениеЗаполнено(ЭлементЗаголовок) Тогда
		...
		ИначеЕсли СвойстваНастройки.Тип = "ГруппаЭлементовОтбора" Тогда
			...
			ЭлементЗаголовок = Строка(НастройкаВариантаКД.ТипГруппы);
		...
		ИначеЕсли СвойстваНастройки.Тип = "ЭлементУсловногоОформления" Тогда
			...
			ЭлементЗаголовок = ОтчетыКлиентСервер.ПредставлениеЭлементаУсловногоОформления(ПользовательскаяНастройкаКД);
...
Процедура УстановитьЦветаДиаграммы(Диаграмма) 
	...
	ИначеЕсли Диаграмма.ТипДиаграммы = ТипДиаграммы.График
		Или Диаграмма.ТипДиаграммы = ТипДиаграммы.ГрафикПоШагам Тогда
