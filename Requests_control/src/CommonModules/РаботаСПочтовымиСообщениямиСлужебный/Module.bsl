	...
	Если Выборка.Следующий() Тогда
		...
		Если ДляПолучения Тогда
			...
			Иначе
				...
				НадоЗаполнитьПолучение = Истина;
			КонецЕсли;
			
		КонецЕсли;
		
		Если Не ДляПолучения Или НадоЗаполнитьПолучение Тогда
			
			Если Не ПустаяСтрока(ТребуемыеСвойства) Тогда
				ТребуемыеСвойства = ТребуемыеСвойства + ",";
			КонецЕсли;	
			ТребуемыеСвойства = ТребуемыеСвойства + СписокСвойствSMTP;
