...
//   * ТолькоДляАдминистраторовСистемы - Массив - имена ролей, которые можно назначать
//     только администраторам сервиса, например:
...
//
//   * ТолькоДляПользователейСистемы - Массив - имена ролей, которые можно назначать только неразделенным
//     пользователям (сотрудникам технической поддержки сервиса и администраторам сервиса), например:
