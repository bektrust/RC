...
Процедура ПараметрыРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Параметры.Вставить("ВыполнитьРегистрациюСхемыE1c", РаботаССообщениями.ТребуетсяРегистрацияСхемыE1c());
	
	Параметры.Вставить("ВыполнитьФормированиеСообщений", РаботаССообщениями.ТребуетсяФормированиеСообщений());
	
	РаботаССообщениями.ОбновитьИспользованиеСозданияСообщений();
