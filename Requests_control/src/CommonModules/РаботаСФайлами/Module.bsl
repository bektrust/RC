...
//
// Для подсистемы "Файловые функции в модели сервиса".
//
Функция СправочникиФайлов() Экспорт
	
	Возврат РаботаСФайламиСлужебный.СправочникиФайлов();
...
Функция ОбъектыХраненияФайловИнформационнойБазе() Экспорт
	...
	Возврат РаботаСФайламиСлужебный.ОбъектыХраненияФайловИнформационнойБазе();
...
Функция РасширениеФайла(Объект) Экспорт
	...
	РаботаСФайламиСлужебный.РасширениеФайла(Объект);
	
КонецФункции

// Выгружает файл по указанному пути.
//
// Для подсистемы "Файловые функции в модели сервиса".
//
Процедура ВыгрузитьФайл(Знач ОбъектФайла, Знач ИмяНовогоФайла) Экспорт
	
	РаботаСФайламиСлужебный.ВыгрузитьФайл(ОбъектФайла, ИмяНовогоФайла);
...
Процедура ЗагрузитьФайл(Знач ОбъектФайла, Знач ПутьКФайлу) Экспорт
	...
	РаботаСФайламиСлужебный.ЗагрузитьФайл(ОбъектФайла, ПутьКФайлу);
