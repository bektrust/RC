...
Процедура ОткрытьФормуСменыПароля(Пользователь = Неопределено, ОбработкаПродолжения = Неопределено) Экспорт
...
Процедура ИнтерактивнаяОбработкаПриОшибкеАвторизации(Параметры, Неопределен) Экспорт
	...
	ПоказатьПредупреждение(Новый ОписаниеОповещения(
			"ИнтерактивнаяОбработкаПриОшибкеАвторизацииПослеПредупреждения", ЭтотОбъект, Параметры),
		ПараметрыКлиента.ОшибкаАвторизации);
	
КонецПроцедуры

// Завершает работу после предупреждения пользователя об ошибке авторизации.
Процедура ИнтерактивнаяОбработкаПриОшибкеАвторизацииПослеПредупреждения(Параметры) Экспорт
