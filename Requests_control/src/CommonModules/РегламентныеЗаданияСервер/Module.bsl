		...
		Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаВМоделиСервиса.ОчередьЗаданий") Тогда
			...
			Если Отбор.Свойство("Метаданные") Тогда
				Если  ТипЗнч(Отбор.Метаданные) = Тип("ОбъектМетаданных") Тогда
					Если Отбор.Метаданные.Предопределенное Тогда
						Отбор.Вставить("Шаблон", МодульОчередьЗаданий.ШаблонПоИмени(Отбор.Метаданные.Имя));
					Иначе
				...
				Иначе
					...
					Если МетаданныеРегламентноеЗадание <> Неопределено Тогда
						Если МетаданныеРегламентноеЗадание.Предопределенное Тогда
							Отбор.Вставить("Шаблон", МодульОчередьЗаданий.ШаблонПоИмени(МетаданныеРегламентноеЗадание.Имя));
						Иначе
