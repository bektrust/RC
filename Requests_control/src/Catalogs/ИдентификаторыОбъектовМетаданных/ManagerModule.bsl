...
Процедура ОбновитьДанные(ЕстьИзменения, ЕстьУдаленные, ТолькоПроверка,
	...
	Попытка
		...
		Если Не ОбъектыРасширений Тогда
			ПодготовитьСписокНовыхПодсистем(Выгрузка);
		КонецЕсли;
...
Процедура ПодготовитьСписокНовыхПодсистем(Выгрузка)
	...
	Для Каждого ИмяПодсистемы Из НовыеПодсистемы Цикл
		Если СведенияОбОбновлении.НовыеПодсистемы.Найти(ИмяПодсистемы) = Неопределено Тогда
			СведенияОбОбновлении.НовыеПодсистемы.Добавить(ИмяПодсистемы);
		КонецЕсли;
	КонецЦикла;
