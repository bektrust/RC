...
Процедура ПерейтиСоСтраницыНастройки()
	...
	СтандартныеПодсистемыКлиент.УстановитьПараметрКлиента("РезервноеКопированиеИБПриЗавершенииРаботы", ПараметрРезервноеКопированиеИБПриЗавершенииРаботы());
...
Функция ПараметрРезервноеКопированиеИБПриЗавершенииРаботы()
	
	Возврат РезервноеКопированиеИБСервер.ПараметрыПриЗавершенииРаботы();
