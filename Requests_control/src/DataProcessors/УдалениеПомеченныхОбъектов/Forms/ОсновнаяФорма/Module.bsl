...
Функция ИзменитьПометкуУдаленияОбъектов(МассивСсылок, ПометкаУдаления)
	...
	СтандартныеПодсистемыКлиентСервер.ОповеститьДинамическиеСписки(Результат, МассивСсылок, ИмяФормы);
...
Процедура ФоновоеЗаданиеЗагрузитьРезультат(Результат)
	...
	Если РезультатВыполненияВФоне.УдалятьПомеченные Тогда
		...
		СтандартныеПодсистемыКлиентСервер.ОповеститьДинамическиеСписки(Результат, РезультатВыполненияВФоне.Удаленные, ИмяФормы);
